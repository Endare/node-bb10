 ...
 */
function PushInitiator(applicationId, password, contentProviderId, evaluation) {
 ...
 */
PushInitiator.prototype.broadcast = function(message, callback) {
 ...
 * @param {Function} callback The callback function that will be invoked when the PPG responds.
 */
PushInitiator.prototype.push = function(message, callback) {
    var deliverBefore = moment().add(8, 'hours').utc();

    var body;

    try {
        body = message.toPAPMessage({
