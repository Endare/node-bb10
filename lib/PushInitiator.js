 ...
 */
function PushInitiatior(applicationId, password, contentProviderId, evaluation) {
...
/**
 * Broadcasts the message to all the devices that are subscribed to the application.
 *
 ...
 */
PushInitiatior.prototype.broadcast = function(message, callback) {
    // Make sure the message doesn't contain any recipients
    message.clearRecepients();

    // Add push_all as a recipient
    message.addRecipient('push_all');
 ...
 * @param {Function} callback The callback function that will be invoked when the PPG responds.
 */
PushInitiatior.prototype.push = function(message, callback) {
